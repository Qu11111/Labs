...
student1 = Student("Ivan", "Golom", 20, {"A": 2, "B": 1, "C": 5})
student2 = Student("Oleg", "Ivanov", 21, {"A": 3, "B": 4, "C": 3})
student3 = Student("Danil", "Gromov", 20, {"A": 3, "B": 2, "C": 4})
...
professor1 = Professor("Marya", "Ramadova", 42, "PhD")
professor2 = Professor("Ekaterina", "Lokeeva", 55, "MD")
professor3 = Professor("Ivan", "Vasiylev", 51, "PhD")
